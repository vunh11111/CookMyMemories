...
//         matchInfo.innerHTML = `マッチ度: ${resultObj.match_info.match_percentage}% (${resultObj.match_info.matched_ingredients}/${resultObj.match_info.total_ingredients}個の材料)`;
...
//             missingInfo.innerHTML = `不足材料: ${resultObj.match_info.missing_ingredients.join(", ")}`;
